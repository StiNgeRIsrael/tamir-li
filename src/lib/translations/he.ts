export const heTranslations = {
  ...
  faqs: [
    ...
    { q: "האם השירות באמת חינמי?", a: "כן! ניתן לבצע עד 5 המרות בחינם ביום. למנויי פרימיום (₪19.90/חודש) — המרות ללא הגבלה וללא מודעות." },
  ...
  tool: {
    ...
    seoFormats: (fromFmts: string[], toFmts: string[]) =>
      `הכלי תומך בהמרה בין כל הפורמטים: ${fromFmts.join(", ")} → ${toFmts.join(", ")}. ניתן לבצע עד 5 המרות בחינם ביום. צריכים יותר? שדרגו לפרימיום ב-₪19.90 בלבד לחודש.`,
  },
  ...
  footer: {
    ...
    seoText3: "תמיר לי זמין בחינם עם עד 5 המרות ביום. למשתמשים שצריכים יותר, מנוי פרימיום ב-₪19.90 לחודש מציע המרות ללא הגבלה, ללא מודעות, ועיבוד מהיר יותר.",
  ...
  premium: {
    price: "₪19.90/חודש", upgradeTo: "שדרג לפרימיום",
  ...
  upgradePage: {
    ...
    badge: "פרימיום",
    headline: "המרות ללא הגבלה. בלי מודעות.",
    subheadline: "מנוי אופציונלי — התוכנית החינמית (5 ביום) נשארת. פרימיום מסיר מגבלות, מודעות ופותח כלי AI.",
    monthlyLabel: "חודשי",
    yearlyLabel: "שנתי",
    yearlySave: "חסכו 20%",
