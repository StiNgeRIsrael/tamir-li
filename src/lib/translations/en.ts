...
export const enTranslations = {
  ...
  tool: {
    ...
    loading: "Loading…",
    watchAdToDownload: "First tap — quick pause",
    downloadNow: "Ready to download",
    downloadGateHint: "One more tap — then your file",
    downloadGateProgress: (step: number) => `Step ${step} of 2`,
    downloadGateStep1Desc: "First tap — quick pause, then you can download",
    downloadGateStep2Desc: "Last tap — download starts",
