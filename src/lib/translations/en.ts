...
export const enTranslations = {
  ...
  admin: {
    ...
    colSort: "Sort",
    adsHint:
      "Hilltopads is the primary ad network; Adsterra loads as fallback when a slot fails. Paste full HTML embeds from the dashboard. Empty Hilltop fields use built-in defaults.",
    adsSectionHilltop: "Hilltopads (primary)",
    adsSectionHilltopHint: "Zones #7184921 banner, #7184937 sidebar, #7184953 mobile, #7184913 popunder.",
    adsSectionAdsterra: "Adsterra (fallback)",
    adsSectionAdsterraHint: "Zone keys — used only when Hilltopads fails to load.",
    adsFieldHilltopBanner: "Hilltop — 728×90 banner (#7184921)",
    adsFieldHilltopSidebar: "Hilltop — 300×250 sidebar (#7184937)",
    adsFieldHilltopMobile: "Hilltop — 300×100 mobile (#7184953)",
    adsFieldHilltopPopunder: "Hilltop — popunder / smartlink (#7184913)",
    adsHintHilltopBanner: "Paste s.src URL or full HTML block.",
    adsHintHilltopSidebar: "Paste s.src URL or full HTML block.",
    adsHintHilltopMobile: "For banner slots with bannerSize=mobile.",
    adsHintHilltopPopunder: "fluffy-machine smartlink — opens on download click.",
    adsFieldBanner: "Adsterra — 728×90 banner (zoneBanner)",
    adsFieldSidebar: "Adsterra — 300×250 sidebar (zoneSidebar)",
    adsFieldSidebar2: "Adsterra — second sidebar (zoneSidebar2)",
    adsFieldInline: "Adsterra — 468×60 inline (zoneInline)",
    ...
    adsFieldInvokeHost: "Adsterra — invoke host (optional)",
    adsHintBanner: "Hex key from atOptions — banner fallback.",
    adsHintSidebar: "Hex key — sidebar fallback.",
    adsHintSidebar2: "Hex key for second rail (slotId ending in -2).",
    adsHintInline: "Hex key for inline / vignette units.",
    adsHintPopunder: "Fallback popunder when Hilltop is unset.",
    ...
    onboardingResponsesTitle: "Onboarding responses",
    onboardingResponsesHint: "Quiz answers and attribution collected from the app welcome funnel.",
    onboardingResponsesError: "Could not load responses.",
  ...
  nativePremiumHint: {
    subtle: "Prefer an ad-free experience?",
    prominent: "Tired of ads? Premium keeps your conversions smooth and uninterrupted.",
    cta: "Go Premium",
  },
  sidebarHome: "Home",
  ...
  useCasePage: {
    ...
    "scanned-pdf-hebrew": {
      ...
      seoDesc: "Uneditable scanned PDF? Free Hebrew OCR, PDF merge, and Word conversion — tools in Hebrew.",
      title: "Convert Scanned Hebrew PDF",
      intro: "Scanned invoices and forms are image-only PDFs. Upload to Hebrew OCR — the tool extracts printed text and exports an editable file.",
      stepsTitle: "Recommended steps",
      steps: [
        "Upload a PDF or image to Hebrew OCR — download extracted text.",
        "If you have multiple scans — merge into one PDF with the PDF manager.",
        "Digital PDF (not scanned)? Try PDF to Word instead of OCR.",
      ],
      toolsTitle: "Relevant tools",
      toolLabels: {
        "/hebrew-ocr": "Hebrew OCR",
        "/merge-pdf": "PDF manager",
        "/pdf-to-docx": "PDF to Word",
      },
      cta: "Start with Hebrew OCR — upload a scan, download text.",
      ctaButton: "Open Hebrew OCR",
    },
    "merge-invoices": {
  ...
  alternativePage: {
    ...
    "kovetz-hebrew": {
      seoTitle: "Tamir.li vs Kovetz — Honest Comparison 2026",
      seoDesc:
        "Kovetz or Tamir.li? Honest comparison: PDF depth vs multi-format, free Hebrew OCR, daily limits, and Premium pricing.",
      title: "Tamir.li vs Kovetz",
      intro:
        "Kovetz (kovetz.co.il) is Israel's PDF desk — 33+ PDF tools, editor, and Pro Doc AI OCR. Tamir.li is your whole file drawer: images, video, audio, documents, and free Hebrew OCR. We don't claim PDF editor parity; we win on breadth and free OCR.",
      tableTitle: "Feature comparison",
      tableHeaders: {
        feature: "Feature",
        tamir: "Tamir.li",
      ...
      rowLabels: {
        hebrewUi: "Hebrew interface",
        formatBreadth: "File types",
        hebrewOcr: "Hebrew OCR",
        freeDaily: "Free tier quota",
        premiumPrice: "Premium price",
        fileSizeFree: "Max file size (free)",
        fileSizePremium: "Max file size (Premium)",
        videoAudio: "Video & audio",
        whatsappTools: "WhatsApp workflows",
      },
      cellLabels: {
        yes: "Yes",
        no: "No",
        many: "Images, video, audio, PDF",
        pdfOnly: "PDF only (~33 tools)",
        freeTier: "Yes — free (Tesseract)",
        proOnly: "Pro only (Doc AI)",
        "5": "5 per day",
        "3hour": "3 per hour (total)",
        ils: "₪19.90/month",
        ilsKovetz: "₪19/mo (or ₪12/mo annual)",
        "50mb": "Up to 50 MB",
        "25mb": "Up to 25 MB",
        "500mb": "Up to 500 MB",
        "100mb": "Up to 100 MB",
      ...
      disclaimer:
        "Kovetz (Kovetz.co.il) is not affiliated with Tamir.li. Data based on public info as of 2026. Need advanced PDF? Kovetz is great. Need images, video, and free OCR too? Stay on Tamir.li.",
      cta: "PDF only? Try Kovetz. All file types? Stay on Tamir.li — drag a file on the homepage.",
      ctaButton: "Start converting free",
    },
  },
  ...
  upgradePage: {
    ...
    comparisonRows: [
      { feature: "File Size Limit", free: "50MB", premium: "500MB", highlight: true },
    ...
    exitIntent: {
      ...
      body: "Yearly Premium saves 20% — unlimited conversions, no ads, and files up to 500MB. Cancel anytime.",
      cta: "See yearly plan",
  ...
  onboarding: {
    ...
    hook: {
      title: "Let's set up Tamir.li for you",
      subtitle: "30 seconds and you're ready. A few quick questions so we tailor it to you.",
      cta: "Let's start",
      bullets: [
        "All your conversion tools in one fast app",
        "Built around how you actually convert",
        "Tuned for your files in seconds",
      ],
    },
    welcome: {
    ...
    questions: {
      ...
      attribution: {
        ...
        options: [
          { id: "play_store" as const, label: "Google Play Store" },
          { id: "google_search" as const, label: "Google search" },
          { id: "friend" as const, label: "A friend recommended it" },
          { id: "social" as const, label: "Social media" },
          { id: "other" as const, label: "Somewhere else" },
        ],
      },
    },
    analyzing: {
      title: "Building your plan…",
      steps: ["Analyzing your answers", "Matching the right tools", "Building your profile"],
    },
    profile: {
      badge: "Your profile is ready",
      subtitle: "We built this from your answers.",
      matchLabel: "match",
      cta: "See my offer",
      traits: {
        category: {
    ...
    auth: {
      ...
      titlePurchase: "Almost there",
      subtitlePurchase: "Sign in with Google, then confirm Premium in Google Play.",
    ...
    offer: {
      ...
      title: "We unlocked a launch price for you",
      subtitle: "Personalized from your answers — save 20% on yearly.",
      timerLabel: "Price disappears in",
      decline: "Maybe later",
      ...
      perMonthEquiv: "Just ₪15.92 / month",
      benefits: [
      ...
      trustBadges: [
        "Full refund on unused conversions",
        "Cancel anytime",
        "No commitment",
      ],
      refundBadge: "Full refund on unused conversions",
      cta: "Activate Premium now",
      ctaPlay: "Sign in & unlock in Google Play",
      ctaLoading: "Opening Google Play…",
      checkoutError: "Could not start checkout. Try again.",
      guarantee: "Full refund on unused conversions · Cancel anytime",
      playYearlyLabel: "Yearly",
      playMonthlyLabel: "Monthly",
      playBillingNote: "Secure checkout via Google Play",
    },
  },
