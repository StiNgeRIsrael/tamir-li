...
export const enTranslations = {
  ...
  faqs: [
    ...
    { q: "Is it really free?", a: "Yes! You can make up to 5 free conversions per day. Premium subscribers (₪19.90/month) get unlimited conversions and no ads." },
  ...
  tool: {
    ...
    seoFormats: (fromFmts: string[], toFmts: string[]) =>
      `This tool supports conversion between all formats: ${fromFmts.join(", ")} → ${toFmts.join(", ")}. You can make up to 5 free conversions per day. Need more? Upgrade to Premium for just ₪19.90/month.`,
  },
  toolNames: {
  ...
  footer: {
    ...
    seoText3: "The free plan includes a limited number of conversions per day. Premium (₪19.90/month) adds higher limits, no ads, and priority processing where available.",
  ...
  premium: {
    price: "₪19.90/month", upgradeTo: "Upgrade to Premium",
  ...
  upgradePage: {
    ...
    badge: "Premium",
    headline: "Unlimited Conversions. Zero Ads.",
    subheadline: "Optional subscription — your free plan (5/day) stays. Premium removes limits, ads, and unlocks AI tools.",
