  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "success-pop": "success-pop 0.55s cubic-bezier(0.16, 1, 0.3, 1) both",
        "success-ring": "success-ring 0.9s ease-out forwards",
        "success-slide-up": "success-slide-up 0.45s cubic-bezier(0.16, 1, 0.3, 1) both",
      },
      backgroundSize: {
        "300%": "300% 300%",
      },
